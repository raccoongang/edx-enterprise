...
class EnterpriseCustomerUser(TimeStampedModel):
    ...
    def inactivate_other_customers(cls, user_id, enterprise_customer):
        """
        Mark as active all the enterprise customers of given user except the given enterprise_customer.
        """
...
class SystemWideEnterpriseUserRoleAssignment(EnterpriseRoleAssignmentContextMixin, UserRoleAssignment):
    ...
    def get_assignments(cls, user, role_names=None):
        ...
        For example:
          ...
          ('enterprise_admin', ['active-enterpirse-uuid', 'inactive-enterpirse-uuid', 'other-inactive-enterpirse-uuid'])
          ('enterprise_learner', ['active-enterpirse-uuid', 'inactive-enterpirse-uuid']),
